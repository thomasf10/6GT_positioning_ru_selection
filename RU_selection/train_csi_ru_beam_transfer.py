"""
Transfer-learning script for joint RU + beam selection.

Strategy
--------
1.  Load a pretrained RU-only Conv3D checkpoint (backbone + ru_id_head).
...
# ---------------------------------------------------------------------------
# Three-head Conv3D model (same as train_csi_ru_beam_sel.py)
# ---------------------------------------------------------------------------
...
def main():
    ...
    run_dir = Path('stored_models_rubeam_transfer') / run_name
    ...
    evaluate_nmse_cdf(
        ...
        title='NMSE CDF: Transfer Learning RU + Beam Selection (CSI) \u2014 Test',
    )
