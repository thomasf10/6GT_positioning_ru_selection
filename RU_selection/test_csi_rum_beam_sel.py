"""
Test script for trained CSI Conv3D joint RU + beam selection models.

Works with checkpoints from both:
  - train_csi_ru_beam_sel.py       (from-scratch 3-head training)
  - train_csi_ru_beam_transfer.py  (transfer-learning 3-head training)
...
from train_csi_ru_beam_sel import (
...
def main():
    ...
    checkpoint_path = 'stored_models_rubeam_transfer/transfer_ep20_bs32_p1lr1e-03_p2lr3e-05_cc16_cl3_fc256_do0.3_0409_1210/best_model.pt'
    #checkpoint_path = 'stored_models_ru_beam_sel/csi_conv3d_ru_beam_ep20_bs32_lr3e-04_cc16_cl3_fc256_do0.3_0409_1032/best_model.pt'
