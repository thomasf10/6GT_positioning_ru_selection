"""
Test script for a trained CSI Conv3D RU selection model.
"""
import sys
...
from train_csi_ru_selection_reduced_office import (
...
def main():
    ...
    checkpoint_path = 'stored_models/csi_conv3d_ep20_bs32_lr3e-04_cc16_cl3_fc256_do0.3_fixed_beams_0408_1024/best_model.pt'
    ...
    nmse_results = evaluate_nmse_cdf(
        ...
        title='NMSE CDF: Optimal vs Conv3D RU Selection (CSI) — Test',
    )
