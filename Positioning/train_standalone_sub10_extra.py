"""
Variant of `train_standalone_sub10.py` that augments the on-grid training set
...
def main():
    ...
    # Reuse the val/test/train split written by the RU run.
    ru_split_path = Path(
    ...
    n_extra_train_users = 0      # set >0 to enlarge the training set
    extra_train_seed = 42        # reproducible random pick of the extras
    ...
    run_dir = Path('stored_models_positioning_sub10_extra') / run_name
    ...
    # Val/test exclude the entire training set (on-grid + extras).
